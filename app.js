document.addEventListener("DOMContentLoaded", ()=>{
    ...
    (function(index){
        ...
        squares[i].onclick = function(){
            ...
            if(squares[index+7].classList.contains("taken"))
            {
                ...
                if(currentPlayer==1 && !(squares[index].classList.contains("player-two")) && !(squares[index].classList.contains("player-one")))
                {
    ...
    function checkBoard() {
        ...
        for(let x = 41; x >=0; x--)
        {
            if(squares[x].classList.contains("player-one") || squares[x].classList.contains("player-two"))
            {
                if(x==0)
                {
